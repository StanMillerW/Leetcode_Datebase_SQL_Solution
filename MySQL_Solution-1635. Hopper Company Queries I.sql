...
FROM
   (SELECT *, MONTH(join_date) AS join_month FROM Drivers WHERE join_date REGEXP '2020' ORDER BY join_date)a RIGHT JOIN temp_month ON a.join_month = temp_month.month, 
