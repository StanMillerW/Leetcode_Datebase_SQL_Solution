...
FROM
    AcceptedRides a INNER JOIN (SELECT *, MONTH(requested_at) AS request_month FROM Rides WHERE requested_at 
				REGEXP '2020' ORDER BY requested_at )r ON a.ride_id = r.ride_id 
